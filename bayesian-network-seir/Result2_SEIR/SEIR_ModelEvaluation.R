...
library(ggplot2)
library(deSolve) 
setwd('/Users/raghavawasthi/Desktop/Drug_Distribution/V1.1/Result2_SEIR/')
########## param ################################
temp_Rx <- NULL
i = 20
incubation_period = 5
...
ggplot(dat, aes(time,mean,group=1))+ 
  ...
  ggtitle('1 Lakh Doses of vaccine Distributed on 16th September') + ylab('Diff')+xlab('Date')
ggsave('1Lakh_Vaccine_SEIR.png',dpi = 300)
